  ...
  <type-skip-layout>
    <section class="all-content-body bg-light">
      <h4 class="content-main-header mt-3 mb-3">
        <p class="content-header">Trashed</p>
      </h4>
      <div class="row cards-body c-card contentdiv" v-if="contents.length > 0">
        <div class="col-md-4" v-for="content in contents" :key="content.key">
            <div class="panel">
        ...
        <div class="row cards-body c-card contentdiv" v-else>
            <div style="
                ...
                <img style="
                  display: block;
                  margin-left: auto;
                  margin-right: auto;width: 12%;" src="/assets/admin/images/new/menu/icons-trash.svg" alt="">
            </div>
            <div style="
                display: flex;
                justify-content: center;
...
export default defineComponent({
  ...
  methods: {
    ...
    makeFavourite(responseId) {
        ...
        this.favouriteForm.post(this.route("restore_fav"),{
            onFinish: () =>this.toast.success("Restored and Added to Favourite Successfully!", {
    ...
    deleteContent(responseId) {
        Swal.fire({
        text: "Are you sure want to permanently delete this content?",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            ...
            this.deleteForm.post(this.route("force_remove"),{
