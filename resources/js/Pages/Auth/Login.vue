                        ...
                        <div class="card border-grey border-grey-shadowcls border-lighten-3 mt-5 pl-4 pr-4 login-sm-h">
                            ...
                            <div class="card-content  w-full">
                                ...
                                <div class="card-body pt-0">
                                    <form class="form-horizontal" @submit.prevent="submit" id="login_form" method="POST">
                                        <fieldset class="form-group floating-label-form-group">
                                            <label class="form_label_cls" for="emailaddress">Email Address</label>
                                            <input v-model="form.email" :class="['form-control', form.errors.email ? 'is-invalid':'']" type="email" id="emailaddress" name="email" placeholder="Enter your email">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-12 text-center text-sm-left">
                                                <Link href="/password-recover" class="card-link forgot_link">
                                                    Forgot
                                                    Password?
                                                </Link>
                                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="bg-pattern w-full">
                                    <div class="card-body p-4">
                                        ...
                                        <form @submit.prevent="submitEmail" id="recover_form" method="POST">
                                            <div class="form-group mb-3">
                                                <label for="emailAddress_r">Email address</label>
                                                <input class="form-control" type="email" id="emailAddress_r" name="email" v-model="recover.email" placeholder="Enter your email">
                                                <span v-if="recover.errors.email" class="error">{{recover.errors.email }}</span>
                                            </div>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            submitEmail() {
                this.recover.processing = true;
                this.recover
                    .transform(data => ({
                        ... data,
                    }))
                    .post(this.route('password-recover'), {
                        onFinish: () => {
                            this.recover.reset('email')
                            this.recover.processing = false
                        }
                    })
            }
        }
