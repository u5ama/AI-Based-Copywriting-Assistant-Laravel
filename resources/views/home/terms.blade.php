                ...
                <div class="column-index hide-on-mobile w-col w-col-4 animated" id="sticky" data-wow-delay="1s" data-wow-duration="1s" style="height:2rem">
                    <div class="w-dyn-list">
                        <div role="list" class="w-dyn-items">
                            <div role="listitem" class="p3 index-link w-dyn-item"><a href="/privacy" class="p3 index-link">Privacy Policy</a></div>
                            <div role="listitem" class="p3 index-link w-dyn-item"><a href="/terms" class="p3 index-link w--current">Terms & Conditions</a></div>
                        </div>
                    </div>
                </div>
