...
@section('title','TypeSkip | Pricing')
@section('header')
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse justify-content-center">
                    ...
                    <div class="navbar-nav ml-auto action-buttons">
                        @if (!request()->session()->has("user"))
                            <a href="{{route('login')}}" class="mr-4 sm-btn white-btn ts-btn ts-effect">Login</a>
                            <a href="{{route('register')}}"  class="lg-btn primary-btn ts-btn">Register</a>
                        @else
                            <a href="{{route('app')}}"  class="lg-btn primary-btn ts-btn">Dashboard</a>
                        @endif
                    </div>
                </div>
            </nav>
            ...
            <div class="index-content-columns w-row">
                ...
                <div class="column-index hide-on-mobile w-col w-col-4 animated" id="sticky" data-wow-delay="1s" data-wow-duration="1s" style="height:2rem">
                    <div class="w-dyn-list">
                        <div role="list" class="w-dyn-items">
                            ...
                            <div role="listitem" class="p3 index-link w-dyn-item"><a href="/privacy" aria-current="page" class="p3 index-link w--current">Privacy Policy</a></div>
                            <div role="listitem" class="p3 index-link w-dyn-item"><a href="/terms" class="p3 index-link">Terms & Conditions</a></div>
                        </div>
                    </div>
                </div>
                <div class="column-content w-col w-col-8">
                    <div class="rich-text w-richtext">
                        ...
                        <p>This Privacy Policy sets out how We, TypeSkip Limited, previously F Stack Limited and also trading as TypeSkip, whose registered office is at Office 25.3, 25 Easton Street, London, WC1X 0DS, England collect and process your personal data and explains your rights in relation to your personal data. If you have any questions about this Privacy Policy or wish to exercise any of your rights in relation to your personal data, you can contact us at this address or by email to support@typeskip.ar. Our preferred contact method is email.</p>
                        ...
                        <p>You may choose the option to log in with Google or share access to Gmail, Google Calendar and/or Google Drive in order to access this information from within the TypeSkip application. When you do so we automatically collect and store Google user data:</p>
                        <ul role="list">
                            <li>Profile</li>
                            <li>Name</li>
                            <li>Email address</li>
                        ...
                        <h3>3.1 Using data from your employer who uses TypeSkip</h3>
                        <p>If we have received your personal data because you are employed at a company that uses TypeSkip as its CRM we will process your personal data to perform any contract we have entered into with your employer or in relation to any steps we take at the request of your employer prior to entering into a contract. Typically, this includes creating a user account for you so that you can access the TypeSkip application.</p>
                        <h3>3.2 Using data from connected Google Services</h3>
                        <p>If we have received your personal data because you have chosen to <strong>Sign in with Google</strong> we will process your personal data to perform any contract we have entered into with your employer or in relation to any steps we take at the request of your employer prior to entering into a contract. In particular, this includes providing you with access to the TypeSkip application.</p>
                        <p>TypeSkip is providing a customer relationship management (CRM) and task management application aimed at business customers. If we have received personal data because you have chosen to connect your Google Drive, Google Calendar and/or your Gmail account we will collect your data from this service in order to enhance the email, file and contact management experience and improve your productivity when using the TypeSkip application. In particular, this includes access to your Google user data from within in the TypeSkip application where you can view your data in the relevant context of a CRM software application and manage your professional relationships.</p>
                        ...
                        <ul role="list">
                            ...
                            <li>TypeSkip’s use of information received, and TypeSkip’s transfer of information to any other app, from Google APIs will adhere to Google’s Limited Use Requirements.</li>
                        </ul>
                        <h3>3.3 Using data you uploaded or entered into the TypeSkip application</h3>
                        ...
                        <p>You can contact us with any questions or comments about your Personal Data, this Policy or any other privacy related enquiries by emailing support@typeskip.ai.</p>
