<div>
    ...
    @foreach($ads['choices'] as $value)
        <div class="note-item response-content-{{$value['id']}}">
            <p class="sc-XhUPp response-content-text-{{$value['id']}}"  data-id="{{$value['id']}}" contenteditable="true">{{ $value['description'] }}</p>
            <div class="note-action">
                <div class="panel-footer">
                    ...
                    <a href="#" class=" pr-2" onClick="favourite(this)" data-id="{{$value['id']}}" data-toggle="tooltip" data-placement="bottom" title="Favourite">
