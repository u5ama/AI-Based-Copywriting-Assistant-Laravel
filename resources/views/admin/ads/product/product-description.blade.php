...
<div class="d-flex justify-content-between dh-title df">
    <div class="fm-title">
        <div class="fm-title-d bg-white"><img src="{{ asset('assets/admin/images/newTemplate/product-description.png') }}"></div>
        <h3>Product Description<br><span class="fm-title-desc">Launching a new product? Let's couple it with a catchy product description.</span></h3>
    </div>
</div>
<!-- end page title -->
