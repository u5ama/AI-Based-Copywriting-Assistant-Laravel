...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-white"><img src="{{  asset('assets/admin/images/newTemplate/blog-outline.svg')}}"></div>
            <h3>Blog Outline<br><span class="fm-title-desc">Write an outline for a blog post using the title.</span></h3>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="form-left">
                <form action="google-ad" id="add_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <label for="ctext">Title:</label>
                        <input type="hidden" name="category" value="{{ encrypt($category) }}">
                        <input type="text"
                               id="brand-remaining"
                               maxlength="80"
                               name="Company"
                               placeholder="e.g. 6 ways to lose weight"
                    ...
                    <div class="form-group addKeyword-field" id="addKeyword-field-1">
                        <label for="ctext">Audience:</label>
                        <input type="text"
                               id="AddKeywordstags"
                               name="add_keywords"
