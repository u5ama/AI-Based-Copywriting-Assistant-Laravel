...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-white"><img src="{{ asset('assets/admin/images/newTemplate/persuasive-bullet-point.png') }}"></div>
            <h3>Persuasive Bullet Points<br><span class="fm-title-desc">Write persuasive bullet points using product description.</span></h3>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="form-left">
                <form action="google-ad" id="add_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <label for="ctext">Product Name:</label>
                    ...
                    <div class="form-group addKeyword-field" id="addKeyword-field-1">
                        <label for="ctext">Tone of Voice:</label>
                        <input type="text"
