        ...
        <div class="d-flex justify-content-between dh-title df">
            <div class="fm-title">
                    <div class="fm-title-d bg-white">
                        @if(request()->is('facebook-ad'))
                            <img src="{{ asset('assets/admin/images/newTemplate/facebook-new.png') }}">
                        @else
                            <img src="{{ asset('assets/admin/images/newTemplate/google-symbol.png') }}">
                        @endif </div>
                    <h3>{{request()->is('facebook-ad')?'Facebook':'Google'}} Ad<br>
                        @if(request()->is('facebook-ad'))
            ...
            <form action="google-ad" id="add_form" enctype="multipart/form-data">
                ...
                {{--<div class="form-group addKeyword-field" id="addKeyword-field-1">
                    ...
                    <input type="text"
                           id="avoid_keyword"
                           name="avoid_keyword"
                           value="{{ old('avoid_keyword') ? old('avoid_keyword') : $contents[0]['ads']->avoid_keyword?? '' }}"
                           class="form-control ctext"
                           multiple="multiple"
                           aria-describedby="ctext">
