...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-white"><img src="{{ asset('assets/admin/images/newTemplate/file.png') }}"></div>
            <h3>Content Improver<br><span class="fm-title-desc">Create compelling product descriptions to be used websites emails and social media.</span></h3>
        </div>
    </div>
    <!-- end page title -->
