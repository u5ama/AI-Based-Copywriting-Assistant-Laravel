                        ...
                        @if ($Item->input_type == 'input')
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old($Item->slug) ? old($Item->slug) : $contents[0]['ads']->company_name ?? ''}}">
                        ...
                        @if ($Item->input_type == 'textarea')
                            <div class="form-group">
                                ...
                                <textarea type="text"
                                          ...
                                          id="company"
                                          rows="3"
                                          class="form-control description-remaining">{{ old($Item->slug) ? old($Item->slug) : ($contents[0]['ads']->description ?? '') }}</textarea>
                                <span class="error" id="{{$Item->slug}}_error"></span>
                            </div>
                        @endif
