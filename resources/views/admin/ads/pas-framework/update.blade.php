...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-pas"><img src="{{ asset('assets/admin/images/newTemplate/pas-framework.png') }}"></div>
            <h3>PAS Framework<br><span class="fm-title-desc">Generate Problem - Agitate - Solution using product Description.</span></h3>
        </div>
    </div>
    <!-- end page title -->
                ...
                <form action="google-ad" id="add_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text"
                                  ...
                                  maxlength="400" placeholder="Write high quality content, product descriptions, and more using just a few keywords or one-liners"
                                  id="company"
                                  rows="3"
