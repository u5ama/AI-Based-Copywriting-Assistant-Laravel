...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-white"><img src="{{ asset('assets/admin/images/newTemplate/sentence-expander.svg') }}"></div>
            <h3>Sentence Expander<br><span class="fm-title-desc">Expand the given paragraphs into longer paragraphs.</span></h3>
        </div>
    </div>
    <!-- end page title -->
