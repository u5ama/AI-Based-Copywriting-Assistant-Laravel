...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-white"><img src="{{ asset('assets/admin/images/newTemplate/facebook-new.png') }}"></div>
            <h3>Facebook video script<br><span class="fm-title-desc">Create product descriptions that sell</span></h3>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="form-left">
                <form action="google-ad" id="add_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="CompanyDescription" maxlength="400" placeholder="Write high quality content, product descriptions, and more using just a few keywords or one-liners" id="company" rows="3" class="form-control ">{{$ad_info['description']}}</textarea>
