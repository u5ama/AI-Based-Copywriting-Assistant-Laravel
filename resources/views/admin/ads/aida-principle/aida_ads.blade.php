...
@section('content')
    ...
    <div class="d-flex justify-content-between dh-title df">
        <div class="fm-title">
            <div class="fm-title-d bg-white"><img src="{{ asset('assets/admin/images/newTemplate/aida-principal.png') }}"></div>
            <h3>AIDA Principle<br><span class="fm-title-desc">Write Attention, Interest, Desire, Action using product description.</span></h3>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="form-right">
                ...
                @if(count($contents)>5)
                    <div style="height: 120px">
                        <div class="d-flex justify-content-center absolute-btnx">
