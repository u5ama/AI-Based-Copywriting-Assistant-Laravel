            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern" style="box-shadow: 5px 5px 5px 5px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        @endif
                        <form action="{{url('admin/login')}}" enctype="multipart/form-data" method="POST" >
                             @csrf
                            ...
                            <div class="form-group mb-0 text-center">
                                <button class="btn btn-primary btn-block" style="background-color: #FE6161;border-color: #FE6161" type="submit"> Log In </button>
                            </div>
